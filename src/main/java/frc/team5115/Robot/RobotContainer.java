...
public class RobotContainer {
   ...
   // public final Mecanum cart = new Mecanum();
    ...
    private void configureButtonBindings() {
        ...
        new JoystickButton(joy, 8).whenPressed(new InstantCommand(arm::Master));
        new JoystickButton(joy, WINCH_MOTOR_ID).whenPressed(new InstantCommand(drivetrain::stop));
